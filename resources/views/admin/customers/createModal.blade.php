    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titleModal">Tambah Pelanggan</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="gender" value="Laki-laki" class="selectgroup-input" checked required>
                                        <span class="selectgroup-button">Laki-laki</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="gender" value="Perempuan" class="selectgroup-input">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="address" id="address" class="form-control" required autocomplete="name" placeholder="Alamat" rows="4"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="phone" class="col-sm-12 control-label">Nomor HP</label>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="phone" name="phone" required autocomplete="phone" placeholder="08123456xxxx">
                                </div>
                            </div>
                        </div>
                    </div>
