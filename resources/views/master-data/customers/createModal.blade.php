                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Nama Pelanggan</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12"><input type="number" class="form-control" id="phone" name="phone" placeholder="Contoh: 081234567890" required></div>
                            </div>
                        </div>
                    </div>
                </form>
