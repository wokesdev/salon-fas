    ...
    function load_data(from_date = '', to_date = '') {
        $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'altered_debit', name: 'altered_debit', render: $.fn.dataTable.render.number('.', ',', 0, 'Rp', ',-') },
                { data: 'altered_kredit', name: 'altered_kredit', render: $.fn.dataTable.render.number('.', ',', 0, 'Rp', ',-') },
            ],
            order: [
                [1, 'asc'], [0, 'asc']
            ],
