                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12"><textarea name="keterangan" id="keterangan" class="form-control" placeholder="Contoh: bayar gaji budi" rows="4" required></textarea></div>
                            </div>
                            <div class="form-group">
                                <label for="tanggal" class="col-sm-12 control-label">Tanggal Pengeluaran Kas</label>
