...
$(document).ready(function () {
    ...
    $('#addButton').click(function(){
        $('.modal-title').text('Tambah Pengeluaran Kas');
        $('#saveButton').val('Add');
        $('#action').val('Add');
    ...
    $(document).on('click', '.edit', function(){
        ...
        $.ajax({
            ...
            {
                $('.modal-title').text('Edit Pengeluaran Kas');
    ...
    if ($("#addEditForm").length > 0) {
        $("#addEditForm").validate({
            ...
            submitHandler: function (form) {
                ...
                if($('#action').val() == 'Add') {
                    action_url = "{{ route('cash-payment.store') }}";
                    swal_title = "Berhasil!";
                ...
                if($('#action').val() == 'Edit') {
                    action_url = "{{ route('cash-payment.update') }}";
                    swal_title = "Berhasil!";
