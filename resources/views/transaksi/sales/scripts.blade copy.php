...
$(document).ready(function () {
    ...
    function add_dynamic_input_field(count)
    {
        ...
        output2 = '<div id="row'+count+'">';
            output2 += '<div class="form-group">';
            output2 += '<label for="servis" class="col-sm-12 control-label">Servis</label>';
            output2 += '<div class="col-sm-12 input-group w-100"><select class="form-control servis" id="servis'+count+'" name="servis[]" required></select><div class="input-group-append">'+button+'</div></div>'
            output2 += '</div>';
            output2 += '<div class="form-group">';
            output2 += '<label for="kuantitas" class="col-sm-12 control-label">Kuantitas</label>';
            output2 += '<div class="col-sm-12"><input type="number" class="form-control input'+count+' kuantitas" id="kuantitas'+count+'" name="kuantitas[]" placeholder="Contoh: 5" required></div>'
            output2 += '</div>';
            output2 += '<div class="form-group">';
            output2 += '<label for="harga_satuan" class="col-sm-12 control-label">Harga Satuan</label>';
            output2 += '<div class="col-sm-12 input-group w-100"><div class="input-group-prepend"><span class="input-group-text">Rp</span></div><input type="number" class="form-control input'+count+' harga_satuan" id="harga_satuan'+count+'" name="harga_satuan[]" placeholder="Contoh: 50.000" required><div class="input-group-append"><span class="input-group-text">,00</span></div></div>'
            output2 += '</div>';
            output2 += '<div class="form-group">';
            output2 += '<label for="subtotal" class="col-sm-12 control-label">Subtotal</label>';
            output2 += '<div class="col-sm-12 input-group w-100"><div class="input-group-prepend"><span class="input-group-text">Rp</span></div><input type="number" class="form-control subtotal" id="subtotal'+count+'" name="subtotal[]" placeholder="0" required readonly><div class="input-group-append"><span class="input-group-text">,00</span></div></div>'
            output2 += '</div>';
            output2 += '<hr class="mt-3 mb-3 bg-dark">'
        output2 += '</div>';
        $('#detailFields2').append(output2);
        ...
        $("#servis" + count).change(function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $('#harga_satuan' + count).val(data.harga);
                },
            });
        });
